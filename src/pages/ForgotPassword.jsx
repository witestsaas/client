        ...
        {submitted ? (
          <div className="text-center py-4">
            ...
            <div className="mt-6 text-center text-sm">
              <Link to="/signin" className="text-[#FFAA00] dark:text-[#FFAA00] hover:underline cursor-pointer">Back to Sign In</Link>
            </div>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-[#FFAA00] dark:bg-[#FFAA00] hover:bg-[#FFAA00]/90 dark:hover:bg-[#FFAA00]/90 text-white dark:text-[#232323] font-semibold py-2 px-4 rounded-md transition-colors cursor-pointer">Send Reset Link</button>
          </form>
        )}
        {!submitted ? (
          <div className="mt-6 text-center text-sm">
